...
Game.prototype.refreshSprites = function(nyanCat, speed, hearts, bomb) {
  var survivors = [];
  ...
  for (var i = 0; i < sprites.length; i++) {
    ...
    if (helpers.checkCollision(currentObject, nyanCat)) {
      ...
      if (currentObject.constructor.name === "Trash"){
        currentObject.blownUp = true;
        bomb = false;
      }
    }
    else if (!helpers.offScreen(currentObject) || !currentObject.blownUp){
...
// debugger
// for (var n = 0; n < sprites.length; i++){
//   if (sprites[i].constructor.name === "Trash"){
//     debugger
//   }
// }
