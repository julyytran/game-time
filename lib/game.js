...
Game.prototype.refreshSprites = function(nyanCat, speed, hearts, lifeCounter) {
  var survivors = []
...
Game.prototype.determineContinue = function(gameLoop, context, canvas, heart3, lifeCounter) {
  if (lifeCounter < 3) {
